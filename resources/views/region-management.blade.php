...
<div class="p-6 md:p-8">
    <h1 class="text-3xl font-bold text-base-content mb-6">Region Management</h1>
    ...
    <div id="datatableSection" class="card bg-base-300 py-3 px-4">
        ...
        'columns' => App\Http\Controllers\RegionController::headerColumn(),
        'searching' => true,
        'ordering' => true,
        ]) !!}
    </div>
    ...
    <div id="formSection" class="hidden">
        @include('components.form.region-form')
    </div>
</div>
