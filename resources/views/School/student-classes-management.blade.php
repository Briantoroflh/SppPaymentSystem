...
<div class="p-6 md:p-8">
    <h1 class="text-3xl font-bold text-base-content mb-6">Student Classes Management</h1>
    ...
    <div id="datatableSection" class="card bg-base-300 py-3 px-4">
        ...
        'columns' => App\Http\Controllers\School\StudentClassesController::headerColumn(),
        'searching' => true,
        'ordering' => true,
        ]) !!}
    </div>
    ...
    <div id="formSection" class="hidden">
        @include('components.form.student-class-form')
    </div>
</div>
