...
<div class="p-6 md:p-8">
    <h1 class="text-3xl font-bold text-base-content mb-6">Student SPP Management</h1>
    ...
    <div id="datatableSection" class="card bg-base-300 py-3 px-4">
        ...
        'name' => 'studentSpp',
        'url' => route('studentSpp.all'),
        'columns' => App\Http\Controllers\School\SppStudentController::headerColumn(),
        'searching' => true,
        'ordering' => true,
        ]) !!}
    </div>
    ...
    <div id="formSection" class="hidden">
        @include('components.form.student-spp-form')
    </div>
</div>
