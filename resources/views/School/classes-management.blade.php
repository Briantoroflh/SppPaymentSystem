...
<div class="p-6 md:p-8">
    <h1 class="text-3xl font-bold text-base-content mb-6">Classes Management</h1>
    ...
    <div id="datatableSection" class="card bg-base-300 py-3 px-4">
        ...
        'name' => 'class',
        'url' => route('class.all'),
        'columns' => App\Http\Controllers\School\ClassesController::headerColumn(),
        'searching' => true,
        'ordering' => true,
        ]) !!}
    </div>
    ...
    <div id="formSection" class="hidden">
        @include('components.form.class-form')
    </div>
</div>
